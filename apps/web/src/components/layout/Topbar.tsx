...
export function Topbar() {
  ...
  const title = location.pathname.startsWith('/audit') ? 'Auditoria' : location.pathname.startsWith('/settings') ? 'Configurações' : isKanban ? 'Jornada comercial' : 'WhatsApps corporativos';
