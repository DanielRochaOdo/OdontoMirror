    ...
    if (mode === 'seller') {
      ...
      try {
        ...
        if (verifyError || !auth.user) {
          ...
          return toast.error('As credenciais foram validadas, mas não foi possível abrir a sessão no Odontoart Connect. Tente novamente.');
        }
